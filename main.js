...
function gatherFormData() {
  let formData = {
    recipient: {
      ...
      house: document.getElementById('recipient_house').value,
      flat: document.getElementById('recipient_flat').value,
      numbers: []
    },
    sender: {
      ...
      house: document.getElementById('sender_house').value,
      flat: document.getElementById('sender_flat').value,
      numbers: []
    }
  };
